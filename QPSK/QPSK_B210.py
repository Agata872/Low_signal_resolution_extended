...
class QPSK_B210(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_mod_demod", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_mod_demod")
        ...
        self._gain_tx_range = qtgui.Range(0, 74, 1, 55, 200)
...
def main(top_block_cls=QPSK_B210, options=None):
