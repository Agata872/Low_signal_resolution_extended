...
class qpsk_Tx(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char,"/home/pi/Low_signal_resolution_extended.git/QPSK/tx_raw.bin",True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, "/home/pi/Low_signal_resolution_extended.git/QPSK/tx.bin", False)
